...
- `HOURS` policies are currently rejected because LeaveMaster's leave consumption model is day/half-day based.
- `PER_PAY_PERIOD` accrual is currently rejected because LeaveMaster does not yet have an authoritative payroll-period schedule.
