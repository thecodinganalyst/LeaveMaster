...
INSERT INTO leave_entitlement_policy (
    ...
    ('SG_UNPAID_INFANT_CARE_U2', NULL, NULL, 'Singapore Unpaid Infant Care Leave - Singapore citizen child under 2', TRUE, 60,
     'DAYS', 12, 'NONE', NULL, 'NONE', FALSE, NULL, NULL, DATE '2025-04-01', NULL,
    ...
    ('SG_SHARED_PARENTAL_EVENT', NULL, NULL, 'Singapore Shared Parental Leave - verified allocated share', TRUE, 60,
