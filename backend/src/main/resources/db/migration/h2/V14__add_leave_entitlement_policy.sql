CREATE TABLE leave_entitlement_policy (
    ...
    PRIMARY KEY (id),
    CONSTRAINT FK_leave_entitlement_policy_leave_type FOREIGN KEY (leave_type_id) REFERENCES leave_type(id)
);
