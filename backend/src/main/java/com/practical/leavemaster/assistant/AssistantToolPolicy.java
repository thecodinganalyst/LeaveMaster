...
final class AssistantToolPolicy {
    ...
    static final Map<String, String> REQUIRED_AUTHORITY = Map.ofEntries(
            ...
            Map.entry("getStaffLeaveAnomalies", RbacPermissions.STAFF_READ), Map.entry("getPendingLeaveActions", RbacPermissions.LEAVE_APPLICATION_READ), Map.entry("getPermittedTeamLeave", RbacPermissions.LEAVE_APPLICATION_READ),
    ...
    static final Set<String> WRITE_TOOLS = Set.of(
            ...
            "createLeaveApprover", "updateLeaveApprover", "deleteLeaveApprover", "applyForLeave", "requestLeaveCancellation", "updateLeaveApplication", "deleteLeaveApplication",
    ...
    static final Set<String> STRUCTURED_RESULT_TOOLS = Set.of(
            "getAllStaff", "getStaffById", "getStaffLeaveEntitlement", "getStaffPolicyContext",
            ...
            "getStaffLeaveAnomalies", "getPendingLeaveActions", "getPermittedTeamLeave",
